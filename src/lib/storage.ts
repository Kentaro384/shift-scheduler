...
const DEFAULT_STAFF: Staff[] = [
    ...
    { id: 3, name: '保育士 01', position: '保育士', shiftType: 'regular', preferredShifts: [], weeklyDays: 5, role: 'age1', incompatibleWith: [], earlyShiftLimit: null, saturdayOnly: false, hasQualification: true },
    { id: 4, name: '保育士 02', position: '保育士', shiftType: 'regular', preferredShifts: [], weeklyDays: 5, role: 'age1', incompatibleWith: [6], earlyShiftLimit: null, saturdayOnly: false, hasQualification: true },
    { id: 5, name: '保育士 03', position: '保育士', shiftType: 'regular', preferredShifts: [], weeklyDays: 5, role: 'age2', incompatibleWith: [], earlyShiftLimit: 2, saturdayOnly: false, hasQualification: true },
    { id: 6, name: '保育士 04', position: '保育士', shiftType: 'regular', preferredShifts: [], weeklyDays: 5, role: 'age2', incompatibleWith: [4], earlyShiftLimit: null, saturdayOnly: false, hasQualification: true },
    { id: 7, name: '保育士 05', position: '保育士', shiftType: 'regular', preferredShifts: [], weeklyDays: 5, role: 'age3', incompatibleWith: [8], earlyShiftLimit: null, saturdayOnly: false, hasQualification: true },
    { id: 8, name: '保育士 06', position: '保育士', shiftType: 'regular', preferredShifts: [], weeklyDays: 5, role: 'age3', incompatibleWith: [7], earlyShiftLimit: null, saturdayOnly: false, hasQualification: true },
    { id: 9, name: '保育士 07', position: '保育士', shiftType: 'regular', preferredShifts: [], weeklyDays: 5, role: 'free', incompatibleWith: [], earlyShiftLimit: null, saturdayOnly: false, hasQualification: true },
